            ...
            <div className="settingsControl w-[80%] h-full max-h-[calc(100vh-80px)] overflow-y-auto bg-[#030712] px-10 box-border flex flex-col items-start">
                ...
                <div className="publisherSettings flex flex-col w-full mt-10 gap-5">
                    ...
                    <div className="settingBox flex flex-row justify-between w-full">
                        <p className="text-white text-lg select-none">Allow users to comment?</p>
                        <div className="freq flex flex-row gap-5">
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer selected"><span> Yes </span></p>
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer"><span> Nope </span></p>
                        </div>
                    </div>
                    <div className="settingBox flex flex-row justify-between w-full">
                        <p className="text-white text-lg select-none">Allow users to tag you in their posts?</p>
                        <div className="freq flex flex-row gap-5">
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer selected"><span> Yes </span></p>
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer"><span> Nope </span></p>
                        </div>
                    ...
                    <div className="settingBox flex flex-row justify-between w-full">
                        <p className="text-white text-lg select-none">Allow email replies?</p>
                        <div className="freq flex flex-row gap-5">
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer"><span> Yes </span></p>
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer selected"><span> Nope </span></p>
                        </div>
                    </div>
                    <div className="settingBox flex flex-row justify-between w-full">
                        <p className="text-white text-lg select-none">Default Reply Email Address</p>
                        <p className="text-[#888] hover:text-white text-lg select-none cursor-pointer">user@example.com</p>
                    </div>
                    <div className="settingBox flex flex-row justify-between w-full">
                        <p className="text-white text-lg select-none">Publisher Visibility</p>
                        <div className="freq flex flex-row gap-5">
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer selected"><span> Public </span></p>
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer"><span> Private </span></p>
                        </div>
                    </div>
                    <div className="settingBox flex flex-row justify-between w-full">
                        <p className="text-white text-lg select-none">Publisher Verification</p>
                        <div className="freq flex flex-row gap-5">
                        <p className="optionalSetting text-[#888] hover:text-white text-lg select-none cursor-pointer selected"><span> Verified <ion-icon name="shield-checkmark" className="relative mt-2"></ion-icon> </span></p>
                        </div>
                    </div>
                </div>
            </div>
