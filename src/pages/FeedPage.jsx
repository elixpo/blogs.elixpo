        ...
        <div className="container absolute flex flex-col h-full max-w-[2560px] bg-[#030712] box-border">
            ...
            <section className="trending pseudo relative flex flex-row items-center w-full h-[40px] bg-[#10141E] px-20 box-border">
                <input
                    type="text"
                    placeholder="Ctrl K"
                    className="w-[30%] h-[40px] bg-[#1D202A] text-white rounded-[20px] px-4 outline-none border border-[#888] focus:border-[#7ba8f0]"
                />
                <div className="trendingTopics h-[40px] max-w-full overflow-x-auto flex flex-row gap-[5px] px-5 box-border ml-[5px] items-center flex-nowrap scrollbar-thin scrollbar-thumb-[#7ba8f0] whitespace-nowrap">
                    <div className="topic ai-recommend relative h-[80%] px-5 flex flex-row gap-[5px] items-center justify-center bg-[#1D202A] rounded-[8px] cursor-pointer hover:bg-[#191e49] hover:text-white transition-all duration-300">
                    ...
                    <div className="topic relative h-[80%] px-3 box-border flex items-center justify-center bg-[#1D202A] rounded-[8px] cursor-pointer hover:bg-[#191e49] hover:text-white transition-all duration-300">
